Cortex-8 --Board Features
Flight Control

STM32H753BIT6 running at 480MHz with hardware crypto engine (AES/HMAC/HASH)
8-motor X8 coaxial support with conflict-free DShot600 bidir on all 8 channels simultaneously (TIM5/TIM3/TIM1 across DMA1/DMA2)
...
Pre-charge soft-switch (2N7002 + 10Ω MELF) fires 5ms before main FET to eliminate inrush current
...
2x INA240A2 current sensors with Kelvin-connected 10mΩ shunts and 50V/V PWM rejection
...
140W USB-PD charging — CH224K negotiates 20V EPR, SC8815 I2C-programmable buck-boost charges both 2S packs in parallel to 8.4V

Digital FPV Video

OpenFPV system — SSC338Q + IMX415 camera stacked on top via 30.5×30.5mm M2 pattern
...
4x M2 mounting holes at 30.5×30.5mm standard stack pattern
